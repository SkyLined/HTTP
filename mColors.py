...
HTTP_RESPONSE_STATUS_LINE_1xx =     0x0F0F;
HTTP_RESPONSE_STATUS_LINE_2xx =     0x0F0A;
HTTP_RESPONSE_STATUS_LINE_3xx =     0x0F0A;
HTTP_RESPONSE_STATUS_LINE_4xx =     0x0F0C;
HTTP_RESPONSE_STATUS_LINE_5xx =     0x0F0D;
HTTP_RESPONSE_STATUS_LINE_INVALID = 0x0F04;
HTTP_REQUEST_RESPONSE_SEPARATOR =   0x0F08;
