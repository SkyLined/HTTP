...
def fOutputInvalidCookieAttribute(oCookieStore_unused, oResponse_unused, oURL, oHeader_unused, sbCookieName, sbCookieValue, sbAttributeName, sb0AttributeValue, bIsNameKnown):
  oConsole.fOutput(
    "      ",
    COLOR_WARNING, CHAR_WARNING,
